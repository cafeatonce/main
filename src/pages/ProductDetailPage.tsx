...
import { ArrowLeft, Star, ShoppingCart, Heart, Share2, Clock, Leaf, Award, ImageIcon } from 'lucide-react';
          ...
          <div className="space-y-6">
            ...
            {product.images && product.images.length > 1 && (
              <div className="flex items-center text-sm text-gray-600 bg-gray-50 px-3 py-2 rounded-lg">
                ...
                <span>{product.images.length} high-quality images available</span>
              </div>
            )}
          </div>
